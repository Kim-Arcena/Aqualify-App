...
public class NewNotesActivity extends AppCompatActivity {
    EditText titlNotenew, contentNotesNew, dateNotesnew;
    Button btnSaveTask, btnCancel;
    Integer noteNum = new Random().nextInt();
    String noteID = Integer.toString(noteNum);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titlNotenew = findViewById(R.id.addTitleNote);
    contentNotesNew = findViewById(R.id.addNoteContent);
    dateNotesnew = findViewById(R.id.addNoteDeadline);
...
//navends
    ...
    btnSaveTask.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            reference = FirebaseDatabase.getInstance().getReference().child("users").child(userId).child("Aqualify").child("Notes" +noteID);
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    dataSnapshot.getRef().child("noteId").setValue(noteID);
                    Intent a = new Intent(NewNotesActivity.this,NotesActivity.class);
